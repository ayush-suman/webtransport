...
var _ quic.SendStream = &sendStream{}
...
func (s *sendStream) CancelWrite(e quic.StreamErrorCode) {
...
var _ quic.ReceiveStream = &receiveStream{}
...
func (s *receiveStream) CancelRead(e quic.StreamErrorCode) {
